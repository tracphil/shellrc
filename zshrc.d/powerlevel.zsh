...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir custom_git_pair vcs_joined)
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(aws virtualenv terraform status)
...
POWERLEVEL9K_AWS_FOREGROUND='yellow'
